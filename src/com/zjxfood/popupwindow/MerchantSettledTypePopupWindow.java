...
public class MerchantSettledTypePopupWindow extends PopupWindow {


	private ListView mListView;
	private View mView;
	
	public MerchantSettledTypePopupWindow(Activity context,OnItemClickListener mItemClickListener,MerchantSettledTypeListAdapter mTypeListAdapter) {
		super(context);
		...
		//设置按钮监听
		mListView.setAdapter(mTypeListAdapter);
