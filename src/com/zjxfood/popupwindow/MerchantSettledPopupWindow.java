...
public class MerchantSettledPopupWindow extends PopupWindow {


	private ListView mListView;
	private View mView;
	
	public MerchantSettledPopupWindow(Activity context,OnItemClickListener mItemClickListener,MerchantSettledListAdapter mSettledListAdapter) {
		super(context);
		...
		//设置按钮监听
		mListView.setAdapter(mSettledListAdapter);
