...
//	private Button btn_take_photo, btn_pick_photo, btn_cancel;
	...
	public SharePopup(Activity context) {
		...
		mMenuView = inflater.inflate(R.layout.share_alert_layout, null);
		mImage = (ImageView) mMenuView.findViewById(R.id.share_image);
		mBitmapUtils = BitmapUtilSingle
				.getBitmapInstance(context);
		...
		mMenuView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				int height = mMenuView.findViewById(R.id.share_content).getTop();
