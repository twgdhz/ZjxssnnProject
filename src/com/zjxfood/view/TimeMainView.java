...
import com.zjxfood.activity.DisplayAuctionActivity;
...
public class TimeMainView extends RelativeLayout implements Runnable {
	...
	public TimeMainView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initView(context);
	}
	
	public TimeMainView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		View.inflate(context, R.layout.timedown_layout, TimeMainView.this);
...
//							isRun = false;
							...
							Intent intent = new Intent(DisplayAuctionActivity.action);
