...
public class ScrollViewContainer extends RelativeLayout {
	...
	private View mBottomChildView,mBottomChildView2;
	 ...
	 */
	private int mEvents;
	public static final String action = "scroll.view.broadcast";
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (!isMeasured) {
			...
			mBottomChildView = ((LinearLayout)bottomView).getChildAt(1);
			mBottomChildView2 = ((LinearLayout)bottomView).getChildAt(2);
			if(mBottomChildView2!=null){
			mBottomChildView2.setOnTouchListener(bottomViewTouchListener);
			}
			mBottomChildView.setOnTouchListener(bottomViewTouchListener);
	...
	private OnTouchListener bottomViewTouchListener = new OnTouchListener() {
		...
		public boolean onTouch(View v, MotionEvent event) {
			ScrollView sv = (ScrollView) v;
			int scrollHegit = sv.getChildAt(0).getMeasuredHeight();
//			RelativeLayout rl = (RelativeLayout) v;
			Log.e("rl", sv.getScrollY()+"=============="+mCurrentViewIndex+"======"+scrollHegit);
			if(scrollHegit-sv.getScrollY()<=947){
//				Log.i("滚动到底了", "滚动到底了====================");
