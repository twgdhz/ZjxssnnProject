 ...
 * 
 */
public class HeadRoundImageView extends ImageView {
	...
	public HeadRoundImageView(Context paramContext) {
		super(paramContext);
	}

	public HeadRoundImageView(Context paramContext, AttributeSet paramAttributeSet) {
	...
	private void drawBorder(Canvas canvas, final int width, final int height) {
		...
		mBorderPaint.setColor(getResources().getColor(R.color.main_title_color));
