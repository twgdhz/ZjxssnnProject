...
//创建订单
public class MyIdaCreateOrderInfo extends AppActivity implements OnClickListener {
...
//				mPrice = price;
			...
			// 跳转到支付方式页面
			case 5:
				Toast.makeText(getApplicationContext(), "订单创建成功",
	...
	private void createOrder() {
		...
		sb.append("gameId=" + mId + "&userId=" + Constants.mId + "&addressId="
				+ mAddressId);
		XutilsUtils.get(Constants.createIndianaOrder, sb,
				new RequestCallBack<String>() {
					@Override
					public void onFailure(HttpException arg0, String arg1) {
					}
