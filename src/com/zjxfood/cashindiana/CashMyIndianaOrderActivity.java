 ...
 * 
 */
public class CashMyIndianaOrderActivity extends AppActivity implements OnClickListener {

	private ImageView mBackImage;
	private ListView mListView;
	private CashMyIndianaOrderAdapter mIndianaOrderAdapter;
	...
	private CashMyIndianaNoPayAdapter mNoPayAdapter;//未付款adapter
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_case_order_layout);
	...
	private void init() {
		...
		mNoDataText = (TextView) findViewById(R.id.my_cash_order_alert_text);
	...
	Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				mIndianaOrderAdapter = new CashMyIndianaOrderAdapter(
			...
			case 3:
				...
				mNoPayAdapter = new CashMyIndianaNoPayAdapter(getApplicationContext(), mPayList);
	...
	OnItemClickListener mClickListener1 = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			intent.setClass(getApplicationContext(), CashMyIdaCreateOrderInfo.class);
	...
	OnItemClickListener mClickListener2 = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			Intent intent = new Intent();
			if(code==1){
				intent.setClass(getApplicationContext(), CashMyIndianaNoPayActivity.class);
			}else if(code==2){
				intent.setClass(getApplicationContext(), CashMyIndianaPayedActivity.class);
			}
			Bundle bundle = new Bundle();
...
//	}
	...
	// 获取已中奖列表
		private void getIndianaSuc() {
			...
			sb.append("userId=" + Constants.mId + "&showTypeCode=" + code
					+ "&pageSize=5" + "&currentPage=" + page);
			XutilsUtils.get(Constants.getMyCash, sb,
					new RequestCallBack<String>() {
						@Override
						public void onFailure(HttpException arg0, String arg1) {
						}
//
		...
		private void getNoPayOrder() {
			...
			XutilsUtils.get(Constants.getCashOrder, sb,
					new RequestCallBack<String>() {
						@Override
						public void onFailure(HttpException arg0, String arg1) {
						}
