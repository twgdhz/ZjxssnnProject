 ...
 *
 */
public class CashIndianaWinningRecordActivity extends AppActivity implements OnClickListener{

	private ImageView mBackImage;
	private ListView mListView;
	private CashIndianaWinRecordAdapter mRecordAdapter;
	...
	Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
			case 1:
				mRecordAdapter = new CashIndianaWinRecordAdapter(getApplicationContext(),mIndianaList);
