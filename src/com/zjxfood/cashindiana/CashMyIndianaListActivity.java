...
import com.zjxfood.indiana.MyIndianaListAdapter;
 ...
 *
 */
public class CashMyIndianaListActivity extends AppActivity implements OnClickListener{
	...
	OnItemClickListener mItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			intent.setClass(getApplicationContext(), CashMyIndianaInfoActivity.class);
			if(mList!=null && mList.size()>0){
