...
//未付款
public class CashMyIndianaPayedActivity extends AppActivity implements OnClickListener {
	...
	protected void onCreate(android.os.Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_indiana_payed_order_value);
	...
	private void init() {
		...
		mMallName = (TextView) findViewById(R.id.indiana_pay_order_head_name);
		mMallPrice = (TextView) findViewById(R.id.indiana_pay_order_head_price_value);
		mUserName = (TextView) findViewById(R.id.indiana_pay_order_receiving_name);
		mUserPhone = (TextView) findViewById(R.id.indiana_pay_order_receiving_phone);
		mUserAddress = (TextView) findViewById(R.id.indiana_pay_order_receiving_address);
		mInfoText1 = (TextView) findViewById(R.id.indiana_pay_order_order_info1);
		mInfoText2 = (TextView) findViewById(R.id.indiana_pay_order_order_info2);
		mInfoText3 = (TextView) findViewById(R.id.indiana_pay_order_order_info3);
		mInfoText4 = (TextView) findViewById(R.id.indiana_pay_order_order_info4);
		mInfoText5 = (TextView) findViewById(R.id.indiana_pay_order_order_info5);
		mInfoText6 = (TextView) findViewById(R.id.indiana_pay_order_order_info6);
		mInfoText7 = (TextView) findViewById(R.id.indiana_pay_order_order_info7);
		mInfoText8 = (TextView) findViewById(R.id.indiana_pay_order_order_info8);
	...
	private void setResource(){
		...
		mInfoText5.setText("订单状态：已付款");
		mInfoText6.setText("物流单号："+mShipmentNum);
		mInfoText7.setText("发货时间："+mShipmentTime);
	}
