...
public class CashIndianaMoreLotteryActivity extends AppActivity implements
		OnClickListener {
	...
	Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				mIndianaInfoAdapter = new CashMyIndianaInfoAdapter(getApplicationContext(), mLotterList,mLuckyNum);
